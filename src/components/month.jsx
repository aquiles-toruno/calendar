                                ...
                                <Week>
                                    {
                                        elementWeek.map(elementDay => {
                                            ...
                                            return <Day key={shortid.generate()} getDate={this.props.getDate} dayNumber={elementDay.number} date={elementDay.date} isWeekend={elementDay.isWeekend} isHoliday={elementDay.isHoliday} isValid={elementDay.isValid} />
                                        })
                                    }
                                </Week>
                            </div>
